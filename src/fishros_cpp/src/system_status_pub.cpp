...
private:
    rclcpp::Publisher<system_status_interface::msg::SystemStatus>::SharedPtr pub;
    rclcpp::TimerBase::SharedPtr timer;

    void timer_callback() {
        system_status_interface::msg::SystemStatus msg;
...
public:
    SysStatusPub() : Node("SysStatusPub") {
        ...
        pub = create_publisher<system_status_interface::msg::SystemStatus>("sys_status", 10);
